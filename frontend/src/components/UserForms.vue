    ...
    <div class="drawer-content">
      ...
      >
        <el-form-item label="First name"  prop="firstName" required>
          <el-col :span="12">
            <el-input v-model="form.firstName" autocomplete="off" placeholder="Please input" />
          </el-col>
        </el-form-item>
        <el-form-item label="Last name" prop="lastName" required>
          <el-col :span="12">
            <el-input v-model="form.lastName" autocomplete="off"  placeholder="Please input"/>
          </el-col>
        </el-form-item>
        <el-form-item label="User email " prop='email' required>
          <el-col :span="12">
            <el-input v-model="form.email" autocomplete="off" placeholder="Please input" />
          </el-col>

        </el-form-item>
        <el-form-item label="Password" prop='password' required>
          <el-col :span="12">
            <el-input v-model="form.password" autocomplete="off" placeholder="Auto generated password" />
          </el-col>
...
export default {
  ...
  watch: { 
    'form.firstName': {
        handler : function () {  this.form.password =  Math.random().toString(36).slice(2).toString(); },
        immediate : true
    }
  },
  computed: {
